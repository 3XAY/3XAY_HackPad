...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DAVINCI] = LAYOUT(
      KC_SPACE, KC_F, LCTL(KC_Q),
      KC_M,   LCTL(KC_BACKSLASH), LALT(KC_BACKSLASH)
  ),
};

#ifdef ENCODER_MAP_ENABLE
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
  [0] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(MS_WHLL, MS_WHLR), ENCODER_CCW_CW(LCTL(KC_EQUAL), LCTL(KC_MINUS)) },
};
#endif
